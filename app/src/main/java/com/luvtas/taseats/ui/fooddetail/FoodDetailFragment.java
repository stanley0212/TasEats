...
import com.luvtas.taseats.ui.comments.CommentFragment;
...
public class FoodDetailFragment extends Fragment implements TextWatcher {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        foodDetailViewModel =
                ViewModelProviders.of(this).get(com.luvtas.taseats.ui.fooddetail.FoodDetailViewModel.class);
    ...
    private void displayInfo(FoodModel foodModel) {
        ...
        //Log.d("Price", foodModel.getPrice().toString());
    ...
    private void calculateTotalPrice() {
        ...
        //Log.d("Price2",  Common.formatPrice(displayPrice).toString());
